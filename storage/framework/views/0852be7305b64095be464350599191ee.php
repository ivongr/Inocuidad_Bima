        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10">
                <div class="container mt-4">
                    ...
                    <form action="<?php echo e(route('vacaciones.update', $vacaciones->Id)); ?>" method="post">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-5">
                                ...
                                <select class="form-select text-center" name="numNomina" id="numNomina" required>
                                    ...
                                    <?php $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($empleado->Id); ?>" <?php echo e($vacaciones->Id_Empleado == $empleado->Id ? 'selected' : ''); ?>>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control text-center" name="FechaInicio" id="FechaInicio"
                                        value="<?php echo e($vacaciones->FechaInicio); ?>" required onchange="calcularTotalDias()">
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2 bg-warning-subtle text-warning-emphasis">
                                    ...
                                    <input type="date" class="form-control text-center" name="FechaFin" id="FechaFin"
                                        value="<?php echo e($vacaciones->FechaFin); ?>" required onchange="calcularTotalDias()">
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2 bg-warning-subtle text-warning-emphasis">
                                    ...
                                    <input type="text" class="form-control" name="TotalDias" id="TotalDias"
                                        value="<?php echo e($vacaciones->TotalDias); ?>" required readonly>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Inocuidad_Bima\resources\views/vacaciones/edit.blade.php ENDPATH**/ ?>