        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10">
                ...
                <div class="container mt-4">
                    ...
                    <div class="container">
                        <div class="row">
                            <h2>  <img src="<?php echo e(asset('images/bajacolor.png')); ?>"
                                alt="Agregar" style="width: 35px; height: 35px;" />
                                <b>Baja Empleados</b></h2>
                                <?php if($errors->any()): ?>
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(url('/storeBaja')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-2 bg-warning-subtle text-warning-emphasis">
                                                <label class="d-block text-center w-100"> <b>Número de Baja</b></label>
                                            </div>
                                            <select class="form-select" name="numBaja" id="numBaja" required>
                                                <option value="">Seleccionar</option>
                                                <?php $__currentLoopData = $numBaja; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $Nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="mb-2 bg-warning-subtle text-warning-emphasis">
                                                <label class="d-block text-center w-100"> <b>Fecha de Baja</b></label>
                                            </div>
                                            <input type="date" class="form-control text-center" name="FechaBaja" id="FechaBaja"
                                                value="<?php echo e(old('FechaBaja')); ?>" required>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Inocuidad_Bima\resources\views/empleados/baja.blade.php ENDPATH**/ ?>