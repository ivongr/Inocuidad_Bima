    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10">
                ...
                <a href="<?php echo e(route('vacaciones.list')); ?>" class="btn btn-secondary ">Volver</a>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Inocuidad_Bima\resources\views/vacaciones/listvacia.blade.php ENDPATH**/ ?>