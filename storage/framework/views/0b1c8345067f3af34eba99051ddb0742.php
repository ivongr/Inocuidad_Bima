...
<head>
    ...
    <title><?php echo e(config('app.name', 'Control')); ?></title>
        ...
        <nav class="navbar navbar-expand-md shadow-sm " >
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/home')); ?>">
                    <img src="<?php echo e(asset('images/bima.png')); ?>" alt="logo" style="width: 100px; height: 65px;" />  <?php echo e(config( 'Control')); ?>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <?php if(Route::has('login')): ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('login')); ?>"><?php echo e(__('Incio de Sesión')); ?></a>
                                </li>
                            <?php endif; ?>
                        ...
                        <?php else: ?>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <img src="<?php echo e(asset('images/usuario.png')); ?>" alt="Usuario" style="width: 40px; height: 40px;" />   <?php echo e(Auth::user()->name); ?>
                                ...
                                <?php if(Route::has('homeuser')): ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('homeuser')); ?>"><?php echo e(__('homeuser')); ?></a>
                                </li>
                                <?php endif; ?>
                            </li>
                        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\Inocuidad_Bima\resources\views/layouts/app.blade.php ENDPATH**/ ?>