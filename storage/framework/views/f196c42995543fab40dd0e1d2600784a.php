            ...
            <div class="col-md-9 col-lg-10">
                ...
                <div class="container mt-4">
                    ...
                    <div class="row row-cols-1 row-cols-md-2">
                        ...
                        <div class="col mb-5">
                            <a href="<?php echo e(route('vacaciones.list')); ?>">
                                <div class="rounded text-center">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Inocuidad_Bima\resources\views/vacaciones/view.blade.php ENDPATH**/ ?>