...
<a href="<?php echo e(route('exportAreaVacaciones', ['buscarpor' => $buscarpor, 'fecha_inicio' => $fecha_inicio, 'fecha_fin' => $fecha_fin])); ?>"
...
<?php else: ?>
<a href="/exportar" class="btn btn-success btn-custom me-2" style="background: #22C55E">
    <img src="<?php echo e(asset('images/excel.png')); ?>" class="me-2"> Exportar a Excel
</a>
<?php endif; ?>

<a href="<?php echo e(route('imprimirArea.pdf', ['buscarpor' => $buscarpor, 'fecha_inicio' => $fecha_inicio, 'fecha_fin' => $fecha_fin])); ?>"
    ...
    <img src="<?php echo e(asset('images/pdf.png')); ?>" class="me-2"> Exportar a PDF
                    ...
                    <table style="margin-top: 20px;" id="vacaciones" class="display" style="width:100% ">
                        <br>
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td><?php echo e(optional($vacacion->empleado)->Nombre); ?> <?php echo e(optional($vacacion->empleado)->ApePat); ?>

                                    <?php echo e(optional($vacacion->empleado)->ApeMat); ?></td>
                                ...
                                <td> <a href="<?php echo e(route('vacaciones.edit', ['Id' => $vacacion->Id])); ?>" class="btn btn-warning text-white">Actualizar</a></td>
                                <td>
                                    <button type="button" class="btn btn-danger" onclick="confirmDelete(<?php echo e($vacacion->Id); ?>)">
                                        Eliminar
                                    </button>
                                </td>
                                <!-- Modal de confirmación de eliminación -->
                                <div class="modal fade" id="confirmDeleteModal<?php echo e($vacacion->Id); ?>" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <br> Esta acción <strong>eliminará el </strong> registró de forma permanente.
                                            </div>
                                            <div class="modal-footer">
    
                                                <form action="<?php echo e(route('vacaciones.destroy', $vacacion->Id)); ?>" method="POST" id="deleteForm<?php echo e($vacacion->Id); ?>">
                                                    <?php echo csrf_field(); ?>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <div>
                            <a href="<?php echo e(route('vacaciones.view')); ?>" class="btn btn-secondary">Volver</a>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Inocuidad_Bima\resources\views/vacaciones/list.blade.php ENDPATH**/ ?>