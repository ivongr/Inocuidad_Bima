        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10">
                ...
                <div class="container mt-4">
                    ...
                    <form action="<?php echo e(url('incapacidades')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control text-center" name="FechaInicio"
                                        id="FechaInicio" value="<?php echo e(old('FechaInicio')); ?>" required
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="TotalDias" id="TotalDias"
                                        value="<?php echo e(old('TotalDias')); ?>" required readonly>
                                </div>
                            </div>
                        </fieldset>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Inocuidad_Bima\resources\views/incapacidad/create.blade.php ENDPATH**/ ?>