        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10">
                ...
                <div class="container mt-4">
                    <h2> <img src="<?php echo e(asset('images/entradacolor.png')); ?>" alt="Agregar" style="width: 35px; height: 35px;" />
                       <b> Registrar Entradas</b></h2>
                    <?php if($errors->any()): ?>
                    ...
                    <form action="<?php echo e(url('/horasEntradas')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="container mt-4">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <fieldset>
                                        <legend class="text-center"> <b>Información</b></legend>


                                        <div class="mb-2 bg-warning-subtle text-warning-emphasis">
                                            <label class="d-block text-center w-100"> <b>Número de Entrada</b></label>
                                        </div>

                                        <select class="form-select" name="numEntrada" id="numEntrada" required>
                                            <option value="">Seleccionar Número de Entrada</option>
                                            <?php $__currentLoopData = $numEntrada; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <br>
                                            <div class="mb-2 bg-warning-subtle text-warning-emphasis">
                                                <label for="horaEntrada" class="d-block text-center w-100"> <b>Hora de
                                                        Entrada</b></label>
                                            </div>

                                            <input type="time" class="form-control" name="horaEntrada" id="horaEntrada"
                                                value="<?php echo e(old('horaEntrada')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Inocuidad_Bima\resources\views/horas/horasEntradas.blade.php ENDPATH**/ ?>