...
<a href="{{ route('exportAreaVacaciones', ['buscarpor' => $buscarpor, 'fecha_inicio' => $fecha_inicio, 'fecha_fin' => $fecha_fin]) }}"
...
<a href="{{ route('imprimirArea.pdf', ['buscarpor' => $buscarpor, 'fecha_inicio' => $fecha_inicio, 'fecha_fin' => $fecha_fin]) }}"
                    ...
                    <table style="margin-top: 20px;" id="vacaciones" class="display" style="width:100% ">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td>{{ optional($vacacion->empleado)->Nombre }} {{ optional($vacacion->empleado)->ApePat }}
                                    {{ optional($vacacion->empleado)->ApeMat }}</td>
                                ...
                                <td> <a href="{{ route('vacaciones.edit', ['Id' => $vacacion->Id]) }}" class="btn btn-warning text-white">Actualizar</a></td>
                                <td>
                                    <button type="button" class="btn btn-danger" onclick="confirmDelete({{ $vacacion->Id }})">
                                        Eliminar
                                    </button>
                                </td>
                                <!-- Modal de confirmación de eliminación -->
                                <div class="modal fade" id="confirmDeleteModal{{ $vacacion->Id }}" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('vacaciones.destroy', $vacacion->Id) }}" method="POST" id="deleteForm{{ $vacacion->Id }}">
                                                    @csrf
                                                    @method('DELETE')
