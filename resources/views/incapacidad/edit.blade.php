        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10">
                <div class="container mt-4">
                    ...
                    <form action="{{ route('incapacidad.update', $incapacidades->Id) }}" method="post">
                        @csrf
                        @method('PUT')
                                ...
                                <select class="form-select text-center" name="numNomina" id="numNomina" required>
                                    ...
                                    @foreach ($empleados as $empleado)
                                        <option value="{{ $empleado->Id }}"
                                            {{ $incapacidades->Id_Empleado == $empleado->Id ? 'selected' : '' }}>
                                            {{ $empleado->NumNomina }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control text-center" name="FechaInicio"
                                        id="FechaInicio" value="{{ $incapacidades->FechaInicio }}" required
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control text-center" name="FechaFin" id="FechaFin"
                                        value="{{ $incapacidades->FechaFin }}" required onchange="calcularTotalDias()">
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2 bg-warning-subtle text-warning-emphasis">
                                    ...
                                    <input type="text" class="form-control" name="TotalDias" id="TotalDias"
                                        value="{{ $incapacidades->TotalDias }}" required readonly>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
