    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10">
            ...
            <div class="container mt-4">
                ...
                <form action="{{ route('horas.actualizarHorasExtras') }}" method="post">
                    @csrf
                    <div class="container mt-4">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="date" class="form-control" name="fecha" id="fecha" value="{{ old('fecha') }}" required onchange="actualizarInfo()">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
