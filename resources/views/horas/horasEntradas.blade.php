        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10">
                ...
                <div class="container mt-4">
                    <h2> <img src="{{ asset('images/entradacolor.png') }}" alt="Agregar" style="width: 35px; height: 35px;" />
                    ...
                    <form action="{{ url('/horasEntradas') }}" method="post">
                        @csrf
                        <div class="container mt-4">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <fieldset>
                                        ...
                                        <select class="form-select" name="numEntrada" id="numEntrada" required>
                                            ...
                                            @foreach ($numEntrada as $id => $nombre)
